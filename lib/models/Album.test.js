...
describe('Album model', () => {
    ...
    describe('totalSongs', () => {
        it('is over 0', () => {
            ...
            const { errors } = album.validateSync();
            expect(errors.totalSongs.message).toEqual('Path `totalSongs` (0) is less than minimum allowed value (1).');
        });
        ...
        it('is under 51', () => {
            ...
            const { errors } = album.validateSync();
            expect(errors.totalSongs.message).toEqual('Path `totalSongs` (51) is more than maximum allowed value (50).');
        });
    });
});
